...
Second part of my JupyterHub deployment in Kubernetes experiment be sure to read [Part I]({filename}./jupyterhub-kubernetes-ldap.md).
...
![GCE disk](/images/blog/2016/08/gce-disk.png "GCE disk")
...
Wait for the service to give you an External IP and login as any LDAP user (see [Part I]({filename}./jupyterhub-kubernetes-ldap.md)).
...
![NFS Files](/images/blog/2016/08/nfs-web.png "NFS Files")
