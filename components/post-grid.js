...
export function PostCard(props) {
    if (props.index == 0) {
        return (
            <div className="w-full rounded md:col-span-2 lg:col-span-3">
                <Link href={props.url}>
                    <a className="flex flex-col md:flex-row min-h-[20rem] p-3 hover:bg-gray-100">
    ...
    return (
        <div className="w-full rounded">
            <Link href={props.url}>
                <a className="w-full h-full p-3 flex flex-row md:flex-col min-h-[8rem] hover:bg-gray-100">
