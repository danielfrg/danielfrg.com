...
In it's simplest form, model management can be seen as training one machine learning model, then repeating this tens, hundreds, or thousands of times with different data, parameters, features and algorithms to finally deploy the _"best"_ one.
...
> _We don't deploy one model, we deploy the process for repeatedly making more. When you deploy a ML model into production you are not saying "this is the best model and we should use it forever". What it actually means is deploying the pipeline for model building and making it more repeatable._
>
...
![](/blog/2018/10/model-management-polyaxon-argo-seldon/diagram.png)
...
![](/blog/2018/10/model-management-polyaxon-argo-seldon/nfs-server.png)

We need to create a couple of directories in the NFS server, so SSH into the node by copying the command available in the post install screen or just clicking the _"SSH to ..."_ button.

![](/blog/2018/10/model-management-polyaxon-argo-seldon/nfs-ssh.png)
...
![](/blog/2018/10/model-management-polyaxon-argo-seldon/nfs-ip.png)
...
<div class="filename">File: polyaxon-config.yml</div>
...
![](/blog/2018/10/model-management-polyaxon-argo-seldon/polyaxon-projects.png)
...
![](/blog/2018/10/model-management-polyaxon-argo-seldon/argo-workflows.png)
...
![](/blog/2018/10/model-management-polyaxon-argo-seldon/polyaxon-experiments.png)
...
![](/blog/2018/10/model-management-polyaxon-argo-seldon/polyaxon-metrics.png)
...
![](/blog/2018/10/model-management-polyaxon-argo-seldon/polyaxon-output.png)
...
![](/blog/2018/10/model-management-polyaxon-argo-seldon/jupyterlab.png)
  ...
  templates:
    ...
    - name: s2i
      container:
        ...
        args:
          [
            "s2i build /src/mnist seldonio/seldon-core-s2i-python3 danielfrg/seldon-mnist:0.2 && docker push danielfrg/seldon-mnist:0.2",
          ]
        volumeMounts:
          - name: work-volume
            mountPath: /src
...
![](/blog/2018/10/model-management-polyaxon-argo-seldon/argo-logs.png)
